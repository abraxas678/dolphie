        ...
        self.command_keys = {
            ConnectionSource.mysql: {
                "Commands": {
                    ...
                    "4": {
                        "human_key": "4",
                        "description": "Toggle panel Replication/Replicas",
                    },
                    "5": {
                        "human_key": "5",
                        "description": "Toggle panel Metadata Locks",
                    },
                    "6": {"human_key": "6", "description": "Toggle panel DDLs"},
                    "7": {
                        "human_key": "7",
                        "description": "Toggle panel Performance Schema Metrics",
                    },
                    "8": {
                        "human_key": "8",
                        "description": "Toggle panel Statements Summary Metrics",
                    },
                    ...
                    "l": {
                        "human_key": "l",
                        "description": "Display the most recent deadlock",
                    },
                    "o": {
                        "human_key": "o",
                    ...
                    "e": {
                        "human_key": "e",
                        "description": "Display error log from Performance Schema",
                    },
                    "t": {
                        "human_key": "t",
                    ...
                    "u": {
                        "human_key": "u",
                        "description": "Display active connected users and their statistics",
                    },
                    "v": {
                        "human_key": "v",
                        "description": "Display variables from SHOW GLOBAL VARIABLES",
                    },
                    "z": {
                        "human_key": "z",
            ...
            ConnectionSource.proxysql: {
                "Commands": {
                    ...
                    "4": {
                        "human_key": "4",
                        "description": "Toggle panel Hostgroup Summary",
                    },
                    "5": {"human_key": "5", "description": "Toggle panel Query Rules"},
                    "6": {
                        "human_key": "6",
                        "description": "Toggle panel Command Statistics",
                    },
                    "placeholder_1": {"human_key": "", "description": ""},
                    "grave_accent": {"human_key": "`", "description": "Open tab setup"},
                    "plus": {"human_key": "+", "description": "Create a new tab"},
                    ...
                    "u": {
                        "human_key": "u",
                        "description": "Display frontend users connected",
                    },
                    "v": {
                        "human_key": "v",
                        "description": "Display variables from SHOW GLOBAL VARIABLES",
            ...
            "mysql_replay": {
                "Commands": {
                    ...
                    "v": {
                        "human_key": "v",
                        "description": "Display global variables from SHOW GLOBAL VARIABLES",
                    },
                    "V": {
                        "human_key": "V",
                        "description": "Display global variables that changed during recording",
                    },
                    "placeholder_4": {"human_key": "", "description": ""},
    ...
    def get_commands(self, replay_file: str, connection_source: ConnectionSource) -> dict[str, dict[str, str]]:
        if replay_file:
            key = {
                ...
                ConnectionSource.proxysql: "proxysql_replay",
            }.get(connection_source, connection_source)
        else:
